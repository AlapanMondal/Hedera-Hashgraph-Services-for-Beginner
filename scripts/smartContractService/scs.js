...
// =================================================================================================
// The following code fetches the Hedera account ID and private key from environment variables and creates 
// a client to connect to the Hedera network:
// =================================================================================================
const myAccountId = process.env.PORTAL_ACCOUNT_ID;
const myPrivateKey = PrivateKey.fromString(process.env.PORTAL_ACCOUNT_PRIVATE_KEY);
let bytecodeFileId;
let contractID;
let fun1_output;
...
async function main() {
    let contractCompiled = require("./smartContract.json");
...
function decodeEvent(eventName, log, topics) {
    const abiFile = require("./smartContract.json");
    abi = abiFile.abi;
